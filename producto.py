...
def agregar_articulo():
    ...
    cantidad_producto = input("Digite la cantidad del producto: ")
    ...
    new_row= pd.DataFrame({'Producto': [nuevo_producto], 'Cantidad': [cantidad_producto], 'Categoria': [agregar_categoria],'Codigo': [last_id + 1], 'Precio compra': [precio_compra], 'Precio venta':[precio_venta] })
